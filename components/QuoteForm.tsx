...
export function QuoteForm() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const requiredFields: FieldName[] = ["name", "phone", "email", "service", "location", "message"];
        ...
        <div className="form-grid">
          ...
          <label>Service/Product
            <select name="service" required value={form.service} aria-invalid={errors.service || undefined} className={errors.service ? "error" : undefined} onChange={(event) => updateField("service", event.target.value)}>
              ...
              <option>Lumber</option><option>Steel</option><option>Tools & Hardware</option><option>Sawmill</option><option>Haulage</option><option>Tree Cutting</option><option>Tree Removal</option><option>Land Clearing</option><option>Material Delivery</option><option>Other</option>
            </select>
          </label>
